/**!
    Nicht als Referenz für gute CSS-Praktiken gedacht. 
    Das Ziel von Hugo in Aktion ist es, dass wir Hugo verstehen. 
    Der HTML/CSS/JS-Code wurde absichtlich kompliziert gestaltet, damit wir die Go-HTML-Vorlagen von Hugo vereinfachen können. 
    Es gibt Fälle, in denen absichtlich CSS-Selektoren anstelle von Klassenparametern für das Targeting verwendet werden. 
    Viele der in CSS vorgenommenen Zielsetzungen sind spezifischer als sie sein sollten. 
    Einige der getroffenen Entscheidungen sind suboptimal. 
 **/
